...
> 🚧 **v0.5 개발 중** — 텍스트 2,978건과 주요 화면 그래픽이 한글화됐습니다.
> 결과·획득 화면까지 처리했고, 남은 일본어(주로 온라인 화면)를 찾아 마무리하는 단계입니다.
...
- 증명서(궁서) 획 굵기 보정·「무승부」 도장 반영
- 검사 도구 확충 — 상자 밖 화소 감사 30케이스 전부 통과
